...
import { Check, Copy, MousePointerClick, Phone } from 'lucide-react';
...
type SecurePhoneProps = {
  number: string;
  className?: string;
};

export const SecurePhone = ({ number, className }: SecurePhoneProps) => {
          ...
          ? (
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium">{t('phone_reveal')}</span>
          ...
          : (
              ...
              >
                <motion.span
                  ...
                  className="text-lg font-bold tracking-tight text-foreground select-all"
                >
                  {number}
                </motion.span>

                <div className="flex items-center border-l border-primary/20 pl-3 gap-2">
                  <button
                    type="button"
                    onClick={handleCopy}
